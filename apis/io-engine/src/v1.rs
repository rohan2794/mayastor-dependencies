...
pub mod nexus {
    pub use super::pb::{
        ...
        FaultNexusChildResponse, GetNvmeAnaStateRequest, GetNvmeAnaStateResponse, ListNexusOptions,
        ...
        RemoveChildNexusRequest, RemoveChildNexusResponse, ResizeNexusRequest, ResizeNexusResponse,
